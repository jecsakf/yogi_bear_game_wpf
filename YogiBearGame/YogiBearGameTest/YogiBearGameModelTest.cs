...
namespace YogiBearTest
{
    ...
    public class YogiBearGameModelTest
    {
        ...
        public void YogiBearGameModelNewGameSmallTest()
        {
            ...
            Assert.AreEqual(0, _model.Table.YogiPosition); // Yogi a kezdőpozíción áll (bal sarok)
            ...
            Assert.AreEqual(23, emptyFields); // szabad mezők száma is megfelelő
        }
        ...
        public void YogiBearGameModelNewGameMediumTest()
        {
            ...
            Assert.AreEqual(119, emptyFields); // szabad mezők száma is megfelelő
        }
        ...
        public void YogiBearGameModelNewGameLargeTest()
        {
            ...
            Assert.AreEqual(287, emptyFields); // szabad mezők száma is megfelelő
        }
        ...
        public void YogiBearGameModelStepTest()
        {
            ...
            _model.Step(-1, 0);
            _model.Step(-1, 0);
            Assert.AreEqual(0, _model.Table.YogiPosition); // az első lépés érvényes, a következővel megint kiléptünk volna a pályáról
        ...
        public void YogiBearGameModelAdvanceTimeTest()
        {
            ...
            Assert.AreEqual(time, _model.GameTime); // az idő nőtt
            Assert.AreEqual(19, _model.Table.Rangers[0]); // és léptek az őrök
            ...
            Assert.AreEqual(time, _model.GameTime); // az idő nem változott, mert áll a játék
            Assert.AreEqual(19, _model.Table.Rangers[0]); // nem léptek az őrök sem
            Assert.AreEqual(10, _model.Table.Rangers[1]);

            _model.GameIsOn = true;
            _model.AdvanceTime();
            time++;
            Assert.AreEqual(time, _model.GameTime); // az idő változott, újra megy a játék
            Assert.AreEqual(20, _model.Table.Rangers[0]); // léptek az őrök is
        ...
        private void Model_GameAdvanced(Object sender, YogiBearEventArgs e)
        {
            ...
            Assert.AreEqual(_model.Table.BasketsCount == _model.Table.PickedBasketsCount || _model.Table.RangerSeeYogi(), _model.IsGameOver); // a tesztben a játéknak csak akkor lehet vége, ha felvettünk minden kosarat, vagy meglátott egy őr
        ...
        private void Model_GameOver(Object sender, YogiBearEventArgs e)
        {
            ...
            Assert.AreEqual(true, _model.Table.BasketsCount == _model.Table.PickedBasketsCount || _model.Table.RangerSeeYogi()); // a tesztben csak akkor váltódhat ki, ha felvettünk minden kosarat, vagy meglátott egy őr
