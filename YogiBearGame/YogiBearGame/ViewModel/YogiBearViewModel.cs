    ...
    public class YogiBearViewModel : ViewModelBase
    {
        ...
        private void RefreshTable()
        {
            foreach (YogiBearField field in Fields) // inicializálni kell a mezőket is
            {
                ...
                string imgpath = "";
                if (_model.Table[field.X, field.Y] == 0) imgpath = "/Resources/empty.png";
                else if (_model.Table[field.X, field.Y] == 1) imgpath = "/Resources/yogi_bear.png";
                else if (_model.Table[field.X, field.Y] == 2) imgpath = "/Resources/park_ranger.png";
                else if (_model.Table[field.X, field.Y] == 3) imgpath = "/Resources/tree.png";
                else if (_model.Table[field.X, field.Y] == 4) imgpath = "/Resources/picnic_basket.png";
                field.Image = imgpath;
            }
        ...
        private void Model_GameCreated(object sender, YogiBearEventArgs e)
        {
            ...
            for (Int32 i = 0; i < _model.Table.Size; i++) // inicializáljuk a mezőket
            {
                ...
                {
                    string imgpath = "";
                    if (_model.Table[i, j] == 0) imgpath = "/Resources/empty.png";
                    else if (_model.Table[i, j] == 1) imgpath = "/Resources/yogi_bear.png";
                    else if (_model.Table[i, j] == 2) imgpath = "/Resources/park_ranger.png";
                    else if (_model.Table[i, j] == 3) imgpath = "/Resources/tree.png";
                    else if (_model.Table[i, j] == 4) imgpath = "/Resources/picnic_basket.png";
        ...
        {
            if (e.GameTime == 1) OnPropertyChanged("IsSmallTableLoaded");
            else if (e.GameTime == 2) OnPropertyChanged("IsMediumTableLoaded");
            else if (e.GameTime == 3) OnPropertyChanged("IsLargeTableLoaded");
        }
