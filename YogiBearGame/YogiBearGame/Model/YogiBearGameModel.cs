...
namespace YogiBearGame.Model
{
    ...
    public class YogiBearGameModel
    {
        ...
        public async Task LoadGameAsync(string path)
        {
            ...
            if (path != String.Empty && !_loadedTables.ContainsKey(Path.GetFileName(path).Substring(0, Path.GetFileName(path).Length - 4)))
        ...
        private void OnGameAdvanced()
        {
            if (GameAdvanced != null)
                GameAdvanced(this, new YogiBearEventArgs(false, _gameTime));
        }
        ...
        {
            if (GameOver != null)
                GameOver(this, new YogiBearEventArgs(isWon,_gameTime));
        }

        private void OnGameCreated()
        {
            if (GameCreated != null)
                GameCreated(this, new YogiBearEventArgs(false, _gameTime));
        }
        ...
        private void OnGameTableLoaded()
        {
            ...
            if (GameTableLoaded != null)
                GameTableLoaded(this, new YogiBearEventArgs(false, table));
        }
        #endregion
